...
const HomeContainer = () => {
  ...
  return (
    <div className="home">
      <div className="home__container flex flex-col justify-center">
        <img
          className="m-auto w-full mt-[70px] rounded-[10px] mb-[10px]"
          src={imgBanner}
          alt=""
        />
            ...
            <div className="home__introduce__text__left">
              <div className="left__text">
                ...
                <p className="left__text--content mt-2 italic">
                  "Công ty TNHH INCA GROUP mang đến người dùng những sản phẩm
                  gia dụng chất lượng, cho khách hàng trải nghiệm tuyệt vời.
                  Incamall cung cấp các đồ dùng nhà bếp như nồi, niêu, xoong,
                  chảo,... với giá cả cạnh tranh trên thị trường, chất lượng đảm
                  bảo. Kiểu dáng sang trọng, tinh tế, cùng với thiết kế thuận
                  tiện cho người sử dụng, mang đến người dùng cảm giác chân
                  thật, tốt và bền. Tiện dụng, đa năng với nhiều tính năng trong
                  một sản phẩm, có thể tận dụng nhiều cách nấu khác nhau. Hãy để
                  căn bếp của bạn trở nên hiện đại và tiện lợi hơn với các “trợ
                  thủ đắc lực" phía bên dưới giỏ hàng nhé. Incamall - luôn trao
                  cho khách hàng trải nghiệm mua sắm tuyệt vời cùng sản phẩm giá
                  tốt, chất lượng."
                </p>
              </div>
            </div>

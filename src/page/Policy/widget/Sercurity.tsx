...
const Sercurity = () => {
    return (
        <div className="policy__sercurity mb-12 mt-[60px]">
            ...
            <h2 className="policy__subtitle">1. Mục đích thu thập thông tin:</h2>
            <p className="policy__text">
                ...
                và để liên hệ xác nhận khi khách hàng đăng ký mua hàng trên website nhằm
                đảm bảo quyền lợi cho người khách hàng.
            </p>
            <p className="policy__text">
                Khách hàng sẽ tự chịu trách nhiệm về bảo mật và lưu giữ mọi hoạt động sử
                dụng dịch vụ dưới tên đăng ký, mật khẩu và hộp thư điện tử của mình.
                Ngoài ra, khách hàng có trách nhiệm thông báo kịp thời cho chúng tôi về
                những hành vi sử dụng trái phép, lạm dụng, vi phạm bảo mật, lưu giữ tên
                đăng ký và mật khẩu của bên thứ ba để có biện pháp giải quyết phù hợp.
            </p>

            <h2 className="policy__subtitle">2. Phạm vi sử dụng thông tin:</h2>
            <p className="policy__text">
            ...
            <ul className="policy__list">
                ...
                <li>
                    ...
                    và liên hệ có liên quan đến giao dịch tại Website incamall.vn.
                </li>
                <li>
                    ...
                    liên quan đến hành vi vi phạm pháp luật nào đó của khách hàng. Ngoài
                    ra, không ai có quyền xâm phạm vào thông tin cá nhân của khách hàng.
                </li>
            </ul>

            <h2 className="policy__subtitle">3. Thời gian lưu trữ thông tin:</h2>
            <p className="policy__text">
            ...
            <ul className="policy__list">
                <li>
                    ...
                    cá nhân hoặc yêu cầu ban quản lý website thực hiện việc này.
                </li>
                <li>
                    Khách hàng có quyền gửi khiếu nại về việc lộ thông tin cá nhân cho bên
                    thứ 3 đến ban quản trị website. Khi tiếp nhận những phản hồi này,
                    chúng tôi sẽ xác nhận lại thông tin, phải có trách nhiệm trả lời lý do
            ...
            <ul className="policy__list">
                ...
                <li>
                    Yêu cầu các cá nhân khi đăng ký/mua hàng là thành viên, phải cung cấp
                    đầy đủ thông tin cá nhân có liên quan như: Họ và tên, địa chỉ liên
                    lạc, email, số chứng minh nhân dân, điện thoại,..., và chịu trách
                    nhiệm về tính pháp lý của những thông tin trên. incamall không chịu
